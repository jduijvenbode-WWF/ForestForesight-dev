...
country = "BRA"
model_path = "D:/temp/ResultsStijn/brazilieModel.model"
...
png("D:/temp/ResultsStijn/corrplotBRA2021.png", width = 1950, height = 1950)
...
library("ggplot2")
png("D:/temp/ResultsStijn/shapplotBra.png", width = 800, height = 1800)
...
for (date in dates){
  ...
  for (tile in tiles) {
    ...
    ff_analyze(prediction$predicted_raster > 0.5, groundtruth = predset$groundtruthraster,
               csvfile = paste0("D:/temp/ResultsStijn/accuracy_analysis/", exp_name, "bra.csv"), tile = tile, date = date,
