            ...
            for file in files:
                if file.endswith("landpercentage.tif"):  # Filter for specific reference files
                    ...
                    with rasterio.open(reference_raster_path) as ref_raster:
                        ...
                        # Create a mask where ref_data is 254, multiplier will be 1, else 0
...
# Directories setup
input_folder = "D:/temp/NewDatasetsStijn/Mennonieten"
output_folder = "D:/temp/NewDatasetsStijn/Mennonietenprocessed"
