...
def adjust_forest_layers(loss_file, forestmask_file, output_dir, tile_info, target_pixel_size):
    ...
    loss_mask = np.where(((loss >=1) & (loss <= 23)), 1, 0)
    ...
    forestmask_2023_path = os.path.join(output_dir, f"{tile_info}_forestmask_2024_400m.tif")
    ...
    print("Save completed for 2023 forest mask.")
...
output_dir = r"D:/temp/ForestmaskJonasscript/2024_1/400x400"  # Updated output directory

# Define the target pixel size as a tuple
target_pixel_size = (0.0002500000000000000052, -0.0002500000000000000052)  # Positive or negative for Y based on your raster orientation
